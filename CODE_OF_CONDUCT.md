...
We as members, contributors, and leaders pledge to make participation in the flckd
...
the project maintainers privately through GitHub (for sensitive reports, use the
repository's private vulnerability reporting channel described in
[SECURITY.md](SECURITY.md), or contact a maintainer directly). All complaints will be
