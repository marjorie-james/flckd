...
CREATE TABLE public.cameras (
    ...
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL,
    last_seen_in_source_at timestamp(6) without time zone,
    consecutive_missing_count integer DEFAULT 0 NOT NULL,
    stale boolean DEFAULT false NOT NULL,
    auto_retired boolean DEFAULT false NOT NULL
);
...
CREATE TABLE public.coverage_areas (
    ...
    region public.geometry(MultiPolygon,4326) NOT NULL,
    data_freshness_at timestamp(6) without time zone,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL
);
...
CREATE TABLE public.data_sources (
    id bigint NOT NULL,
    name character varying NOT NULL,
    kind character varying DEFAULT 'community'::character varying NOT NULL,
...
--
-- Name: monitored_segments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.monitored_segments (
    id bigint NOT NULL,
    ...
    snap_distance_m double precision DEFAULT 0.0 NOT NULL,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL
);
...
--
-- Name: monitored_segments_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.monitored_segments_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: monitored_segments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.monitored_segments_id_seq OWNED BY public.monitored_segments.id;


--
-- Name: refresh_runs; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.refresh_runs (
    ...
    duration_ms integer,
    per_source jsonb DEFAULT '{}'::jsonb NOT NULL,
...
--
-- Name: refresh_runs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.refresh_runs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: refresh_runs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.refresh_runs_id_seq OWNED BY public.refresh_runs.id;
...
--
-- Name: monitored_segments id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.monitored_segments ALTER COLUMN id SET DEFAULT nextval('public.monitored_segments_id_seq'::regclass);


--
-- Name: refresh_runs id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.refresh_runs ALTER COLUMN id SET DEFAULT nextval('public.refresh_runs_id_seq'::regclass);
...
--
-- Name: monitored_segments monitored_segments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.monitored_segments
    ADD CONSTRAINT monitored_segments_pkey PRIMARY KEY (id);


--
-- Name: refresh_runs refresh_runs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: index_cameras_auto_retired; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_cameras_auto_retired ON public.cameras USING btree (auto_retired) WHERE auto_retired;


--
-- Name: index_cameras_on_data_source_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_cameras_on_data_source_id ON public.cameras USING btree (data_source_id);


--
-- Name: index_cameras_on_data_source_id_and_external_ref; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_cameras_on_data_source_id_and_external_ref ON public.cameras USING btree (data_source_id, external_ref);


--
-- Name: index_cameras_on_location; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_cameras_on_location ON public.cameras USING gist (location);


--
-- Name: index_cameras_on_stale_true; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_cameras_on_stale_true ON public.cameras USING btree (stale) WHERE stale;


--
-- Name: index_cameras_on_verification_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_cameras_on_verification_status ON public.cameras USING btree (verification_status);


--
-- Name: index_coverage_areas_on_region; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_coverage_areas_on_region ON public.coverage_areas USING gist (region);
...
CREATE INDEX index_monitored_segments_on_camera_id ON public.monitored_segments USING btree (camera_id);


--
-- Name: index_monitored_segments_on_geometry; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_monitored_segments_on_geometry ON public.monitored_segments USING gist (geometry);


--
-- Name: index_monitored_segments_on_osm_way_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_monitored_segments_on_osm_way_id ON public.monitored_segments USING btree (osm_way_id);


--
-- Name: index_refresh_runs_on_started_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_refresh_runs_on_started_at ON public.refresh_runs USING btree (started_at);


--
-- Name: index_refresh_runs_on_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_refresh_runs_on_status ON public.refresh_runs USING btree (status);
...
--
-- Name: monitored_segments fk_rails_0fd4693f59; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.monitored_segments
    ADD CONSTRAINT fk_rails_0fd4693f59 FOREIGN KEY (camera_id) REFERENCES public.cameras(id);
...
--
-- Name: cameras fk_rails_436b07ffa6; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cameras
    ADD CONSTRAINT fk_rails_436b07ffa6 FOREIGN KEY (data_source_id) REFERENCES public.data_sources(id);
